...
- (void)logAddedPaymentInfo:(CDVInvokedUrlCommand *)command {
    NSDictionary *params =
    @{FBSDKAppEventParameterNameSuccess : [[command.arguments objectAtIndex:0] intValue]};;
    [FBSDKAppEvents
...
- (void)logCompletedRegistrationEvent:(CDVInvokedUrlCommand *)command {
    NSDictionary *params =
    @{FBSDKAppEventParameterNameRegistrationMethod : [command.arguments objectAtIndex:0]};
    [FBSDKAppEvents
